      ...
      if (writeUptime()) {
        ...
        switch (activePage)
        {
          case StartPage:
            ...
            switch (counter) {
              case 1:
                break;
              case 2:
                writeObject(ANGULARMETER, 0, map((int)(readBatteryLevel() ), 0,85,0, 30)); //BATTERY METER
                counter = 0;
                break;
              case 3:
                //writeObject(LEDDIGITS, 5, (uint16_t)leftMotorSpeed);         //Left Encoder
                break;
              case 4:
                //writeObject(LEDDIGITS, 6, (uint16_t)rightScale);         //Right encoder
                break;
              case 5:
               // writeObject(LEDDIGITS, 12, pastrightScale);         //Right encoder
                break;
              case 6:
             // writeObject(LEDDIGITS, 11, rightLimit);         //Left encoder
                break;
              case 7:
          ...
          case MacroTester:
            ...
            {
              case 1:
                writeObject(LEDDIGITS, 14, heading);   //Heading
                break;
              case 2:
                writeObject(LEDDIGITS, 20, displacement);   //Displ
                break;
              case 3:
                writeObject(LEDDIGITS, 23, lidarAngle);   //Angle
                break;
              case 4:
                writeObject(LEDDIGITS, 24, lidarDist);   //Dist
                break;
              case 5:
              ...
              case 7:
                ...
                break;
              case 8:
                writeObject(LEDDIGITS, 7, abs(xCoordLidar));   //R
                
                break;
              case 9:
                writeObject(LEDDIGITS, 8, abs(yCoordLidar));   //R
                counter = 0;
